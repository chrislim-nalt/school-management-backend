...
// Create student - FIXED with better error handling
exports.createStudent = async (req, res) => {
  try {
    ...
    // Create student data WITHOUT studentId - let the model generate it
    const studentData = {
      name: req.body.name.trim(),
      grade: req.body.grade,
      className: req.body.className,
    ...
    // Create and save student - studentId will be auto-generated by pre-save hook
